...
![дополнительный репозиторий MySQL](./img/install_mysql_6.5.png "дополнительный репозиторий MySQL")
...
Рис.6: управление deb-пакетами (установка и удаление)
...
Рис.8: результаты создания базы данных в командной строке
...
Рис.9: результаты заполнения таблицы dogs в командной строке
...
Рис.10: результаты заполнения таблицы cats в командной строке
...
Рис.11: результаты заполнения таблицы hamsters в командной строке
...
Рис.12: результаты заполнения таблицы horses в командной строке
...
Рис.13: результаты заполнения таблицы camels в командной строке
...
Рис.14: результаты заполнения таблицы donkeys в командной строке
...
Рис.15: результаты очистки таблицы camels в командной строке
...
Рис.16: результаты слияния таблиц horses и donkeys в командной строке
...
Рис.17: создание таблицы “молодые животные” запросом в консоли
...
Рис.18: результат создания таблицы “молодые животные” запросом в консоли
...
Рис.19: создание таблицы “все животные” запросом в консоли
...
Рис.20: результат создания таблицы “все животные” запросом в консоли
